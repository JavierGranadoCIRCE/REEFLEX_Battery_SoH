...
from SAnD.core.model import NARX_Transformer_2var, NARX_Transformer, NARX_Transformer_2var_SoloActual, \
    NARX_Transformer_3var_SoloActual
...
def cargar_modelo_pth_finetuning(modelo, path_modelo):
    modelo = NARX_Transformer_3var_SoloActual(feature_dim1,feature_dim2, num_attention, num_cycles, num_preds)
...
def export_trained_model_to_onnx(feature_dim1,feature_dim2, num_attention, num_cycles, num_preds):
    ...
    checkpoint = torch.load("save_params/trained_model_narx_3var_1ciclo.pth", map_location="cpu")
    ...
    torch.onnx.export(
        ...
        "save_params/trained_model_narx_3var_1ciclo.onnx",
