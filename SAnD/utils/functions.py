...
def export_trained_model_to_onnx(feature_dim1,feature_dim2, num_attention, num_cycles, num_preds):
    ...
    checkpoint = torch.load("save_params/trained_model_narx_2var_1ciclo_NASA_Sandia_3.pth", map_location="cpu")
    ...
    torch.onnx.export(
        ...
        "save_params/trained_model_narx_2var_1ciclo_NASA_Sandia_3.onnx",
        input_names=["x_pair"],
